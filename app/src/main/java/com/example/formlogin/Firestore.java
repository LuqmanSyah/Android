...
import com.example.formlogin.adapter.UserAdapter;
...
public class Firestore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Firestore.this);
        ...
        userAdapter.setDialog(new UserAdapter.Dialog() {
            ...
            public void onClick(int pos) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Firestore.this);
